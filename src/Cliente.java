...
class cliente extends JFrame implements ActionListener
{
    ...
    JLabel lb_titulo = new JLabel("Manutenção de cliente - www.informaticon.com.br");

    //Labels dos campos da tabela;
    JLabel label_id                  = new JLabel("Identifique..: ");
    JLabel label_nome                = new JLabel("Nome Cliente..: ");
    ...
    cliente()
    {
        setTitle("Formulário de manutenção de cliente - www.informaticon.com.br - Prof Neri");
        setSize(800,600);
        setLocation(150,80);
        setResizable(false);
    ...
    //Gera cor frente dos texfields setForegroundColor()
        tf_id                 .setForeground(Color.blue);
    ...
    //Gera cor frente de fundo texfields setBackroundColor()
        ...
        botao_primeiro_registro  .setBackground(Color.yellow);
        botao_registro_anterior  .setBackground(Color.yellow);
        botao_proximo_registro   .setBackground(Color.yellow);
        botao_ultimo_registro    .setBackground(Color.yellow);
        botao_novo               .setBackground(Color.yellow);
        botao_gravar             .setBackground(Color.yellow);
        botao_alterar            .setBackground(Color.yellow);
        botao_excluir            .setBackground(Color.yellow);
        panel_pesquisa.setBackground(Color.yellow);
        
        //Posicionando os componentes labels e textfields da tabela
        label_id              .setBounds(100,120,100,20);
        tf_id                 .setBounds(200,120,77,20);
        label_nome            .setBounds(297,120,100,20);
        tf_nome               .setBounds(397,120,350,20);

        //Posicionando os botoes com setBounds()
        botao_primeiro_registro  .setBounds(100,150,40,30);
        botao_registro_anterior  .setBounds(150,150,40,30);
        botao_proximo_registro   .setBounds(200,150,40,30);
        botao_ultimo_registro    .setBounds(250,150,40,30);
        botao_novo               .setBounds(300,150,40,30);
        botao_gravar             .setBounds(350,150,40,30);
        botao_alterar            .setBounds(400,150,40,30);
        botao_excluir            .setBounds(450,150,40,30);
       ...
       //lookandfeel();
        ...
        url          = "jdbc:mysql://localhost/geraClasse";
        usuario      = "root";
        senha        = "69Motominha";
        try
        {
              ...
              while(resultset.next())
                   cb_pesquisa.addItem(resultset.getString("nome"));
              resultset.first();
   ...
   public void lookandfeel()
   {
    ...
    public void vai_primeiro_registro()
    {
     ...
     public void excluir()
     {
       try
       {
           String nome = "Deletar cliente : "+tf_nome.getText()+" ?";
           System.out.println("nome = " + nome);
           int opcao_escolhida = JOptionPane.showConfirmDialog(null,nome,"Exclusão ",JOptionPane.YES_NO_OPTION);
           if (opcao_escolhida == JOptionPane.YES_OPTION)
           {
               String  sql = "DELETE FROM cliente Where id = "+ tf_id.getText();
...
public void pesquisadigitacao()
{
   try
   {
       ...
       while(!achou)
       {
           String pesquisado = resultset.getString("nome").substring(0,(tamanho_pesquisa)).toUpperCase();
        ...
        tf_id.setText(resultset.getString("id"));//Essas duas linhas é necesária
        mostra_conteudo_nos_campos();
        cb_pesquisa.setSelectedItem(tf_nome.getText());
    }
    catch(Exception erro)
...
public void pesquisaviacombobox()
{
   try
   {
       ...
       while(!achou)
       {
           String pesquisado = resultset.getString("nome");
